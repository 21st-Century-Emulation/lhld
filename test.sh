...
EXPECTED='{"opcode":42,"state":{"a":181,"b":0,"c":0,"d":0,"e":0,"h":4,"l":3,"flags":{"sign":false,"zero":false,"auxCarry":false,"parity":false,"carry":false},"programCounter":0,"stackPointer":0,"cycles":18}}'
